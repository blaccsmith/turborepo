...
## Report bugs using Github's [issues](https://github.com/blaccsmith/turborepo/issues)

We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/blaccsmith/turborepo/issues/new/choose); it's that easy!

## Create a bug report 

Select [**Create Issue**](https://github.com/blaccsmith/turborepo/issues) from the repository.

 ![Select button for issue](/.github/new-issue.png)
 

 Select [**Get Started**](https://github.com/blaccsmith/turborepo/issues) for Bug Report.
