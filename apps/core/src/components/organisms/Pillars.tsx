      ...
      <div className="flex flex-col items-center">
        ...
        <div className="h-4/5 w-4/5">
          ...
          <div className="flex h-full w-full">
            {/* Stack */}
            <div className="relative mr-4 flex w-max flex-col items-end justify-between ">
              {pillars.map((pillar, idx) => (
                ...
                >
                  <p className="mt-2 pr-2 align-bottom text-4xl text-slate-300 hover:text-purple-400">
                    {pillar.label}
                  </p>
              ...
              <div
                className={`absolute ${scrollBarConfig[pos].top} h-1/4 w-0.5 bg-purple-400 transition-all duration-500`}
              />
            </div>
            {/* Stack */}
            <div className="h-[207px] overflow-y-hidden" ref={scrollingContainer}>
              {pillars.map(pillar => (
                <div key={pillar.description} className="h-[207px] px-4">
